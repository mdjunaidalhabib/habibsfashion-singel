...
export default function DeliveryPayment() {
  return (
    <section id="delivery" className="py-12 md:py-16">
      <Container>
        <h2 className="text-3xl font-extrabold text-slate-900">Delivery & Payment</h2>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-slate-600">All over Bangladesh delivery available.</p>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-slate-600">Dhaka: 1–3 days • Outside: 3–5 days</p>
          </div>
        </div>
      </Container>
    </section>
